		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#reversestring1reversestringproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"reversestring1reversestringproject-display": {
								"semanticObject": "reversestring1reversestringproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=reversestring1.reversestringproject",
									"url": sap.ui.require.toUrl("reversestring1/reversestringproject")
								}
							}
						}
					}
